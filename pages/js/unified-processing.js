...
### ⚠️ 섹션 13 (참고문헌) 특별 지시
- **참고문헌은 위의 "업로드된 RAW ID 목록"이 절대로 아닙니다!**
- RAW1, RAW2, RAW3 등 업로드된 파일 목록을 참고문헌에 나열하지 마세요.
- 참고문헌은 보고서 작성에 참조한 **학술 논문 목록**만 기재합니다.
- 학술 논문이 없으면 "해당사항 없음"을 출력하세요.
- 올바른 예시: "Kim JS et al. J Korean Med Sci. 2023;38(1):e1-e10."
- 잘못된 예시: "RAW1.1: 제품 첨부문서" ← 이것은 참고문헌이 아님!
